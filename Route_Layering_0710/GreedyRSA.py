...
from service_recovery import ServiceRecovery
...
if __name__ == '__main__':
    ...
    Greedy = GreedyRSA(distance_margin, ots_margin, osnr_margin, subgraph_file_path='./subgraphs/' + 'example1' + '/', file_path='example/', file_name='example1', band=24)

    # Greedy = GreedyRSA(distance_margin, ots_margin, osnr_margin, subgraph_file_path='./subgraphs/' + 'example2' + '/', file_path='example/', file_name='example2', band=8)
    Greedy.RSA()
